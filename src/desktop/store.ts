...
const initial: Record<AppId, WindowState> = {
  gmail: defaultWindow("gmail", "Inbox — sophie.lefevre@nexaflow.io", "📧", 120, 60, 1100, 680),
  ...
  workable: defaultWindow("workable", "Workable — NexaFlow Recruitment", "🎯", 180, 100, 1040, 640),
  teams: defaultWindow("teams", "Teams — NexaFlow SA", "📞", 260, 140, 960, 600),
  calendar: defaultWindow("calendar", "Calendar — Apr 19, 2026", "📅", 220, 120, 980, 600),
  securex: defaultWindow("securex", "Securex — Payroll Portal", "🔒", 280, 150, 920, 580),
  folders: defaultWindow("folders", "NexaFlow HR Folders", "📁", 200, 120, 900, 560),
