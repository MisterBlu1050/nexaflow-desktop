...
exports.handleSlashCommand = exports.findCommand = exports.commandMap = exports.policyLookup = exports.performanceReview = exports.peopleReport = exports.onboarding = exports.draftOffer = exports.compAnalysis = exports.isoNow = exports.randTypingDelay = void 0;
const randTypingDelay = () => Math.floor(Math.random() * (1400 - 800 + 1)) + 800;
exports.randTypingDelay = randTypingDelay;
const isoNow = () => new Date().toISOString();
exports.isoNow = isoNow;
const makeFooter = (legalRef) => ({ validation: 'auto-validated', legalRef, generatedIn: (0, exports.isoNow)() });
// /comp-analysis
const compAnalysis = (_args) => {
    ...
    return {
        ...
        typingDelay: (0, exports.randTypingDelay)(),
        cardColor: '#F59E0B',
        data: {
            table: [
...
exports.compAnalysis = compAnalysis;
// /draft-offer
const draftOffer = (args) => {
    if (!args || !args.trim()) {
        return {
            command: '/draft-offer',
...
exports.draftOffer = draftOffer;
// /onboarding
const onboarding = (_args) => {
    const preArrival = [
...
exports.peopleReport = peopleReport;
// /performance-review
const performanceReview = (_args) => {
...
exports.policyLookup = policyLookup;
exports.commandMap = {
    '/comp-analysis': exports.compAnalysis,
    '/draft-offer': exports.draftOffer,
    '/onboarding': exports.onboarding,
    '/people-report': exports.peopleReport,
    '/performance-review': exports.performanceReview,
    '/policy-lookup': exports.policyLookup,
};
const findCommand = (cmd) => exports.commandMap[cmd] || null;
exports.findCommand = findCommand;
const handleSlashCommand = (cmd, args, ctx) => {
    const handler = (0, exports.findCommand)(cmd);
    if (!handler) {
        return {
            command: cmd,
