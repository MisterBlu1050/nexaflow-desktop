...
const NOTIFS = [
  ...
  { time: "08:55", color: "bg-status-orange", text: "7 candidates pending in ATS", app: "ATS" },
  { time: "08:30", color: "bg-status-yellow", text: "Board People Report due at 5PM", app: "Teams" },
  { time: "08:00", color: "bg-status-green", text: "April payroll confirmed by Payroll Provider", app: "Payroll" },
];
