...
Lena`,
  ...
  },
  {
    id: "workable",
    from: "ATS",
    fromAddr: "noreply@ats.example",
    subject: "7 candidates awaiting review",
    preview: "7 candidates awaiting review — 3 urgent Engineering roles",
    time: "07:55",
    priority: "white",
    body: `You have 7 candidates awaiting your review across 3 Engineering roles. Log into the ATS to take action.`,
  },
  {
    id: "securex",
    from: "Payroll Provider",
    fromAddr: "no-reply@payroll.example",
            ...
            <div className="p-6">
              ...
              <div className="flex items-start gap-3 pb-4 border-b border-gmail-hover">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[12px] text-gmail-muted">To: chro@demo.local</div>
                </div>
